...
<body bgcolor="#f1f1f1">
    ...
    <center>
        <table bgcolor="#FFFFFF" width="740px" height="400px" border="1" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="3">
             ...
             <tr>
                    ...
                    <td width="800px" height="500px"valign="top"><tiles:insert attribute="body" /></td>
