 ...
 * @author a
 */
public class AccessoryBrandBean extends org.apache.struts.action.ActionForm {
    
    private int accessry_brand_id;
    private String accessoty_brand_name;
    private List<AccessoryBrandVO> listOfAccessoryBrand;
    ...
    /**
     * @return the listOfAccessoryBrand
     */
    public List<AccessoryBrandVO> getListOfAccessoryBrand() {
        return listOfAccessoryBrand;
    }

    /**
     * @param listOfAccessoryBrand the listOfAccessoryBrand to set
     */
    public void setListOfAccessoryBrand(List<AccessoryBrandVO> listOfAccessoryBrand) {
        this.listOfAccessoryBrand = listOfAccessoryBrand;
    }
}
